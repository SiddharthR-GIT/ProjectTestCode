...
public class DistanceMatrix {
    ...
    static class Response implements ApiResponse<com.google.maps.model.DistanceMatrix> {
        ...
        @Override
        public com.google.maps.model.DistanceMatrix getResult() {
            return new com.google.maps.model.DistanceMatrix(originAddresses, destinationAddresses, rows);
        }
    }
}
